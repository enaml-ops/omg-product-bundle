...
func (s *Plugin) GetFlags() (flags []pcli.Flag) {
	return []pcli.Flag{
		...
		pcli.CreateStringFlag("cf-release-url", "url for cf bosh release", CFReleaseURI),
		pcli.CreateStringFlag("garden-release-url", "url for garden bosh release", GardenReleaseURI),
		pcli.CreateStringFlag("diego-release-url", "url for diego bosh release", DiegoReleaseURI),
		pcli.CreateStringFlag("etcd-release-url", "url for etcd bosh release", EtcdReleaseURI),
		pcli.CreateStringFlag("cf-mysql-release-url", "url for cf-mysql bosh release", CFMysqlReleaseURI),
		pcli.CreateStringFlag("cflinuxfs2-release-url", "url for cflinuxfs2 bosh release", CFLinuxReleaseURI),

		pcli.CreateStringFlag("cf-release-sha", "sha for cf bosh release", CFReleaseSHA),
		pcli.CreateStringFlag("garden-release-sha", "sha for garden bosh release", GardenReleaseSHA),
		pcli.CreateStringFlag("diego-release-sha", "sha for diego bosh release", DiegoReleaseSHA),
		pcli.CreateStringFlag("etcd-release-sha", "sha for etcd bosh release", EtcdReleaseSHA),
