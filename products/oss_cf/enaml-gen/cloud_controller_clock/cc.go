...
*/
	...
	/*BitsService - Descr: Public url for the bits-service service Default: 
*/
...
*/
	...
	/*PendingDroplets - Descr: How often the droplet pending cleanup job runs Default: 300
*/
	PendingDroplets *PendingDroplets `yaml:"pending_droplets,omitempty"`
