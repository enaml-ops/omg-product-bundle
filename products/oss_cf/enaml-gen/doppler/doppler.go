...
*/
	...
	/*OutgoingPort - Descr: Port for outgoing log messages via websockets Default: 8081
*/
	OutgoingPort interface{} `yaml:"outgoing_port,omitempty"`

	/*GrpcPort - Descr: Port for outgoing log messages via GRPC Default: 8082
*/
	GrpcPort interface{} `yaml:"grpc_port,omitempty"`
