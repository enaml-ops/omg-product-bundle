...
*/
	...
	/*BitsService - Descr: Private url for the bits-service service Default: 
*/
	BitsService *BitsService `yaml:"bits_service,omitempty"`
...
*/
	...
	/*Jobs - Descr: Number of local cloud_controller_worker workers Default: 2
*/
...
*/
	...
	/*DefaultQuotaDefinition - Descr: The name of the quota definition CC will fallback on for org and space limits from the list of quota definitions. Default: default
*/
...
*/
	...
	/*Buildpacks - Descr: The type of blobstore backing to use. Valid values: ['fog', 'webdav'] Default: fog
*/
...
*/
	...
	/*RunPrestartMigrations - Descr: Run Cloud Controller DB migrations in BOSH pre-start script. Should be changed to false for deployments where the PostgreSQL job is deployed to the same VM as Cloud Controller. Otherwise, the default of true is preferable. Default: true
*/
	RunPrestartMigrations interface{} `yaml:"run_prestart_migrations,omitempty"`
...
*/
	...
	/*Packages - Descr: Directory (bucket) used store app packages.  It does not have be pre-created. Default: cc-packages
*/
...
*/
	...
	/*Droplets - Descr: Key pair name for signed download URIs Default: 
*/
...
*/
	...
	/*NginxRateLimitGeneral - Descr: The rate limiting and burst value to use for '/' Default: <nil>
*/
	NginxRateLimitGeneral interface{} `yaml:"nginx_rate_limit_general,omitempty"`
...
*/
	...
	/*NginxRateLimitZones - Descr: Array of zones to do rate limiting for.  Default: <nil>
*/
	NginxRateLimitZones interface{} `yaml:"nginx_rate_limit_zones,omitempty"`

	/*QuotaDefinitions - Descr: Hash of default quota definitions to be seeded. This property can be used to add quotas with subsequent deploys, but not to update existing ones. Default: <nil>
*/
