	...
	return enaml.InstanceJob{
		...
		Properties: &cf_mysql_broker.CfMysqlBrokerJob{
			...
			Services: []map[string]interface{}{
				newDefaultServicePlan(plgn),
			},
		},
	}
}

func newDefaultServicePlan(plgn *Plugin) (res map[string]interface{}) {
	res = make(map[string]interface{})
	res["name"] = "p-mysql"
	res["id"] = "5e5f56da-9b39-43a5-840c-682d5412020b"
	res["description"] = "MySQL service for application development and testing"

	res["dashboard_client"] = map[string]string{
		"id":           "p-mysql",
		"secret":       plgn.ServiceSecret,
		"redirect_uri": "https://p-mysql.sys." + plgn.BaseDomain,
	}
