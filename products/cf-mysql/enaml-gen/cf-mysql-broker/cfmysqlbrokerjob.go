...
*/
	...
	/*MysqlNode - Descr: Cache size used by galera (maximum amount of data possible in an IST), in MB Default: 512
*/
...
*/
	...
	/*Nats - Descr: Password for broker to register a route with NATS Default: <nil>
*/
