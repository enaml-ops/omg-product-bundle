...
*/
	...
	/*ResourcePool - Descr: The location of the webdav server eg: https://blobstore.com Default: 
*/
...
*/
	...
	/*Thresholds - Descr: The cc will restart if memory remains above this threshold for 15 monit cycles Default: 384
*/
...
*/
	...
	/*Droplets - Descr: The ca cert to use when communicating with webdav Default: 
*/
