...
func (s *Plugin) GetFlags() (flags []pcli.Flag) {
	return []pcli.Flag{
		...
		createIntFlag("cc-uploader-poll-interval", "CC uploader job polling interval, in seconds", "25"),
		...
		createStringFlag("support-address", "Support URL", "https://support.pivotal.io"),
		createStringFlag("min-cli-version", "Min CF CLI Version supported", "6.7.0"),
		...
		createIntFlag("doppler-drain-buffer-size", "message drain buffer size", "10000"),
		...
		createStringFlag("uaa-company-name", "name of company for UAA branding", "Pivotal"),
		...
		createStringFlag("uaa-footer-legal-txt", "legal text for UAA branding", "Legal Text"),
